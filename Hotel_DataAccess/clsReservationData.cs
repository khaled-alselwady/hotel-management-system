...
{
public static bool GetReservationInfoByID(int? ReservationID, ref int PersonID, ref int RoomID, ref DateTime ReservedForDate, ref byte NumberOfPeople, ref byte Status, ref DateTime CreatedDate, ref int CreatedByUserID)
{
    bool IsFound = false;
...
public static int? AddNewReservation(int PersonID, int RoomID, DateTime ReservedForDate, byte NumberOfPeople, byte Status, DateTime CreatedDate, int CreatedByUserID)
{
...
public static bool UpdateReservation(int? ReservationID, int PersonID, int RoomID, DateTime ReservedForDate, byte NumberOfPeople, byte Status, DateTime CreatedDate, int CreatedByUserID)
{
    int RowAffected = 0;
