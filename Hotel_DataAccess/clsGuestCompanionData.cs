            ...
            ref int? GuestID)
        {
            ...
            try
            {
                using (SqlConnection connection = new SqlConnection(clsDataAccessSettings.ConnectionString))
                {
                    ...
                    using (SqlCommand command = new SqlCommand("SP_GetGuestCompanionInfoByID", connection))
                    {
        ...
        public static int? AddNewGuestCompanion(int? PersonID, int? GuestID)
        {
            ...
            try
            {
                using (SqlConnection connection = new SqlConnection(clsDataAccessSettings.ConnectionString))
                {
                    ...
                    using (SqlCommand command = new SqlCommand("SP_AddNewGuestCompanion", connection))
                    {
                        command.CommandType = CommandType.StoredProcedure;
                        ...
                        GuestCompanionID = (int?)outputIdParam.Value;
                    }
                }
            }
            catch (SqlException ex)
        ...
        public static bool UpdateGuestCompanion(int? GuestCompanionID, int? PersonID, int? GuestID)
        {
            ...
            try
            {
                using (SqlConnection connection = new SqlConnection(clsDataAccessSettings.ConnectionString))
                {
                    ...
                    using (SqlCommand command = new SqlCommand("SP_UpdateGuestCompanion", connection))
                    {
                        command.CommandType = CommandType.StoredProcedure;
        ...
        public static bool DeleteGuestCompanion(int? GuestCompanionID)
        {
            ...
            try
            {
                using (SqlConnection connection = new SqlConnection(clsDataAccessSettings.ConnectionString))
                {
                    ...
                    using (SqlCommand command = new SqlCommand("SP_DeleteGuestCompanion", connection))
                    {
                        command.CommandType = CommandType.StoredProcedure;
        ...
        public static DataTable GetAllGuestCompanions()
        {
            ...
            try
            {
                using (SqlConnection connection = new SqlConnection(clsDataAccessSettings.ConnectionString))
                {
                    ...
                    using (SqlCommand command = new SqlCommand("SP_GetAllGuestCompanions", connection))
                    {
                        command.CommandType = CommandType.StoredProcedure;
